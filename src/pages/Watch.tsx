    ...
    <>
      {
        currentPlaying && currentPlaying?.videoId === id && (
          <div className="max-h-screen overflow-hidden">
            ...
            <div className="flex w-full Viewport-Heigh-SB">
              <div className="flex gap-y-10 gap-x-5 p-7 mx-20 mr-0 w-full overflow-auto">
                <div className="maxW800">
                  <div>
                    <iframe src={`https://www.youtube.com/embed/${id}?autoplay=1`} frameBorder="0" width="800" height="502" allow="autoplay" allowFullScreen title='Youtube Video Player'></iframe>
                    ...
                    <div className="flex gap-4 flex-col border-solid border-dark-600 border-2 my-5 pb-3 border-l-0 border-r-0">
                      <div className="flex items-center gap-5 mr-5 mt-4">
                        ...
                        <div className="w-5/6">
                          ...
                          <h6 className="text-dark-400 text-xs">
                            {currentPlaying.channelInfo.subscribers} subscribers
                          </h6>
                        </div>
                        <div>
                          <button className="uppercase bg-red-logo rounded-sm p-2 text-sm tracking-wider">
                            subscribe
                          </button>
                        </div>
                      </div>
